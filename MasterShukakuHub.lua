...
-- Cria o conteúdo do ChatSpy dentro da customPage
...
MessageList.Size = UDim2.new(1, 0, 0.9, 0)
MessageList.Position = UDim2.new(0, 0, 0.05, 0)
...
-- Não há botão de fechar! Para "sumir" com a interface, faça via script se quiser:
-- chatSpyPage.Visible = false